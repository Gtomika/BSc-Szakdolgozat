...
\begin{definicio}{Zárt részhalmaz}
	Egy átmenetmátrix elemeinek $L$ kommunikációs osztálya zárt, ha minden $i \in L$ és $j$ állapotok esetén, ha $i$-ből el lehet jutni $j$-be, akkor $j \in L$.  
\end{definicio}
...
tartozó sajátvektor. Mivel egy sajátvektor bármilyen nem nulla skalár szorosa is 
...
hogy a PageRank egy invariáns eloszlás is, ahol a komponensek összege éppen 1.
