...
\begin{proof}
	...
	Ekkor $S = e_1 e_2^T$, ahol $e_1$ a csupa egyeseket, $e_2$ pedig a csupa $\frac{1}{n}$ komponenseket tartalmazó oszlopvektorok. Mivel $S$ felírható ilyen alakban, ezért $Rank(S) = 1$ és csak két sajátérték lehetséges $e_1^T e_2^T = 1$ és 0 \cite{rankonematrix}.   
